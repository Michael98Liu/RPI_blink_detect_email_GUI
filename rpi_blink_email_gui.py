...
def detect_start(blink_count=0,last_blink=0, blink_threshold=10, lux_old=1000, time_threshold=12, lux_threshold=500, email_min_timespan=60, detection_period=0.1):
        ...
        while True:
            ...
            if blink_count>=blink_threshold:
                ...
                if now-last_sent>=email_min_timespan:
                    ...
                    last_sent=now
                    print("Email sent.")
                    label = ttk.Label(root, text = 'Email sent!\nTo do your new laundry, please press button.')
                    label.pack()
                    return
...
# GUI initialization
root = Tk()
hello = ttk.Label(root, text = 'Have you put your laundry in?\nIf yes, press to start!')
hello.pack()
button = ttk.Button(root, text = 'Start!', command = detect_start)
button.pack()
